...
###################################################################################       
        ...
        def load_and_clean_data(self, data_file):
            ...
            df = pd.concat([df, reason1, reason2, reason2, reason4], axis = 1)
       ...
       'Education', 'Children', 'Pets', 'Absenteeism Time in Hours']
            ...
            # re-order the columns in df
            column_names_new = ['Reason1', 'Reason2', 'Reason3', 'Reason4', 'Month Value', 'Day_of_the_week',
       ...
       'Daily Work Load Average(in Minutes) ', 'Body Mass Index', 'Education', 'Children', 'Pets', 'Absenteeism Time in Hours']
            ...
            df = df.drop(['Day_of_the_week','Daily Work Load Average(in Minutes) ','Distance to Work'],axis=1)
